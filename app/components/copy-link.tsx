  ...
  return (
    <div className="flex shrink-0 gap-2">
      <button
        ...
        className="rounded-full border border-line bg-card px-4 py-2 text-sm font-semibold text-ink-soft transition hover:border-ink-faint hover:text-ink"
      >
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 rounded-full bg-[#25D366] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#1eb457]"
      >
